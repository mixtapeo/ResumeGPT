...
- WildApricot does not provide files through its API; you must utilize member IDs, match them to file IDs, and retrieve files via `{base_url}/attachments/{file_id}` for each member.
